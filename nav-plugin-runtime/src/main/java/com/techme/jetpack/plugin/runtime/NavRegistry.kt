...
object NavRegistry {
    ...
    init {
        navList.add(NavData("tags_fragment","com.techme.jetpack.nav.TagsFragment",false,Fragment))
                navList.add(NavData("user_fragment","com.techme.jetpack.nav.UserFragment",false,Fragment))
